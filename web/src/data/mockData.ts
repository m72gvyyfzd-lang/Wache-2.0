...
export const mockJobs: Job[] = [
  ...
  { jobNr: 1, routentyp: "HH", bezeichnung: "MS BEISPIEL", fkwTickerAbgang: new Date("2026-08-02T09:00:00") },
  { jobNr: 2, routentyp: "HH", bezeichnung: "MS SEEBRISE", hhHoltenau: new Date("2026-08-02T06:00:00") },
  { jobNr: 3, routentyp: "HH", bezeichnung: "MS NORDLICHT", stadeKuden: new Date("2026-08-02T10:00:00") },

  // NOK-Route (Kanal): Holtenau -> Kuden
  { jobNr: 4, routentyp: "NOK", bezeichnung: "MS KANALFAHRT", stadeKuden: new Date("2026-08-02T08:00:00") },
  { jobNr: 5, routentyp: "NOK", bezeichnung: "MS PROBEFAHRT", hhHoltenau: new Date("2026-08-02T05:00:00") },
